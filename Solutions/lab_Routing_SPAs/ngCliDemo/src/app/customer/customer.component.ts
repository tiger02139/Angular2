...
export class CustomerComponent implements OnInit {
  ...
  ngOnInit() {
    this._customer = CustomerComponent.customers[this.customerId];
  ...
  update() {
    ...
    // if (this.customerForm.get('firstName').status == "VALID") { this.customer.firstName = this.customerForm.get('firstName').value};
